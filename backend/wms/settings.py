...
DATABASES = {
    'default': {
        ...
        "USER": get_docker_secret("backend_db_user", os.environ.get("POSTGRES_USER", 'user')),
        "PASSWORD": get_docker_secret("backend_db_password", os.environ.get("POSTGRES_PASSWORD", 'password')),
