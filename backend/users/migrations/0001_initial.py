...
def create_user_groups(apps, schema_editor):
    ...
    Group.objects.bulk_create([Group(name=name) for name in users.models.UserGroups])
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Warehouse Manager', 'Warehouse Manager'), ('Picker/Packer', 'Picker/Packer'), ('Supplier', 'Supplier')], max_length=255)),
